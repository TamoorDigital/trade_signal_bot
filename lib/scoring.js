...
// Rebalanced AGAIN 2026-09-04 after a 37-trade review cross-checked across
// 3 independent analyses (manual calculation, Gemini, ChatGPT) — all 3
// agreed: liquiditySweep was over-rewarded (higher in LOSSES than
// non-losses, ~0.76-0.83 normalized either way), BOS was the strongest
// discriminator (~0.69 losses vs ~0.80 non-losses), momentumVolume showed
// consistent moderate separation. Moved weight from sweep into BOS+momentum.
// Total stays 93. See section 7.6 changelog for the full reasoning and why
// MIN_SCORE was NOT raised this round (data contradicted the prior round's
// MIN_SCORE recommendation).
const WEIGHTS = {
  htfBias: 15,
  trendRegime: 12,
  freshPOI: 22,
  liquiditySweep: 11,  // was 16 (12 originally) — over-rewarded per 3 analyses
  bos: 15,             // was 12 (12 originally) — strongest discriminator
  choch: 5,
  crtTbs: 4,
  momentumVolume: 7,   // was 5 — consistent moderate signal across analyses
  candlePattern: 2,
};
